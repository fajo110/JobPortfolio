...
/**
 * Background View: Draw 4 full-screen coloured triangles
 */
public class BackgroundView extends View {
    ...
    public BackgroundView(Context context, AttributeSet attrs) {
        ...
        mColors[0] = a.getColor(R.styleable.BackgroundView_colorSegmentOne, Color.LTGRAY);
        mColors[1] = a.getColor(R.styleable.BackgroundView_colorSegmentTwo, Color.WHITE);
        mColors[2] = a.getColor(R.styleable.BackgroundView_colorSegmentThree, Color.CYAN);
